...
def fasta_to_relaxed_phylip(input_alignment):
    output_phylip_path = f"{input_alignment.replace('.fasta', '_relaxed')}"
    AlignIO.convert(input_alignment, 'fasta', f'{output_phylip_path}.phylip', 'phylip-relaxed')
...
def fasta_to_strict_phylip(input_alignment):
    ...
    output_phylip_path = f"{input_alignment.replace('.fasta', '_strict')}"
    SeqIO.write(import_list, f'{output_phylip_path}.phylip', "phylip")
    return(output_phylip_path)
